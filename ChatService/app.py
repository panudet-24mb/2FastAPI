...
from db import (
    ...
    save_message,
    get_messages,
    set_notification_leave_event,
    set_users_status,
    set_users_count_clear,
)
...
def handle_join_room_event(data):
    ...
    join_room(data["room"])
    set_users_status(data["room"], data["username"], True)
    set_users_count_clear(data["room"], data["username"])
...
def handle_leave_room_event(data):
    ...
    set_users_status(data["room"], data["username"], False)
    set_notification_leave_event(data["room"], data["username"])
